 ...
 * 
 * This file is part of migration.
 * 
 ...
 */
class ShopMigratorViewMigration extends JView{
    
    function display($tpl = null) {
        JToolBarHelper::title(JText::_('ShopMigrator Migration', 'generic.png'));
        ...
        $class =& $model->getClass($systemId);
        $this->assignRef('tasks', $tasks);
        $this->assignRef('class', $class->class);
        parent::display($tpl);
    }
    
    function edit($id) {
        JToolBarHelper::title(JText::_('ShopMigrator Migration: [<small>Edit</small>]', 'generic.png'));
        JToolBarHelper::save();
    ...
    function add(){
        JToolBarHelper::title( JText::_('ShopMigrator Migration')
                . ': [<small>Add</small>]' );
        JToolBarHelper::save();
